...
public class AsistenciaService {
    ...
    public AsistenciaService(AsistenciaRepository repository, EmpleadoRepository empleadoRepository) {
        this.repository = repository;
        this.empleadoRepository = empleadoRepository;
    }

   
    public List<EmpleadoModel> listarEmpleados() throws SQLException {
        return empleadoRepository.listarTodos();
    }

    public boolean marcarEntrada(String idEmpleado) throws SQLException {
    ...
    public boolean marcarSalida(String idEmpleado) throws SQLException {
        if (idEmpleado == null || idEmpleado.isBlank()) {
    ...
    public List<Asistencia> listarAsistenciasDeHoy() throws SQLException {
    ...
    public boolean registrarHorasExtra(int idAsistencia, double horasExtra) throws SQLException {
        if (idAsistencia <= 0) {

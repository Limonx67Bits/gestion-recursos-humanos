...
public class EmpleadoModel {
    ...
    public String getNumeroVialidad() {
        return numeroVialidad;
    }

    public void setNumeroVialidad(String numeroVialidad) {
        this.numeroVialidad = numeroVialidad;
    }

    public String getNumeroCasaLote() {
        return numeroCasaLote;
    }

    public void setNumeroCasaLote(String numeroCasaLote) {
        this.numeroCasaLote = numeroCasaLote;
    }
    ...
    public String toString() {
        return "EMPLEADO: " + primerNombre + " || DPI: " + dpi;
    }
}
